...
const BanStaffModal = ({ open, handleClose, userData, fetchUsersData }) => {
  ...
  return (
    ...
    >
      <DialogTitle textAlign="center">{`Bạn có muốn khóa tài khoản của nhân viên " ${userData.fullName} " không ?`}</DialogTitle>
