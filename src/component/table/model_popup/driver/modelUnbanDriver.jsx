...
const UnbanDriverModal = ({ open, handleClose, userData, fetchUsersData }) => {
  ...
  return (
    ...
    >
      <DialogTitle textAlign="center">{`Bạn có muốn kích hoạt lại tài khoản của tài xế " ${userData.fullName} " không ?`}</DialogTitle>
...
export default UnbanDriverModal;
